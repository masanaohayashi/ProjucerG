...
//==============================================================================
void LF1Component::paint (juce::Graphics& g)
{
...
void LF1Component::sliderValueChanged (juce::Slider* sliderThatWasMoved)
{
...
void LF1Component::buttonClicked (juce::Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="LF1Component" componentName=""
                 parentClasses="public juce::Component" constructorParams="" variableInitialisers=""
                 lookAndFeel="juce::LookAndFeel_V1" snapPixels="8" snapActive="1"
