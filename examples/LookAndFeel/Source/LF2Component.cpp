...
//==============================================================================
void LF2Component::paint (juce::Graphics& g)
{
...
void LF2Component::sliderValueChanged (juce::Slider* sliderThatWasMoved)
{
...
void LF2Component::buttonClicked (juce::Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="LF2Component" componentName=""
                 parentClasses="public juce::Component" constructorParams="" variableInitialisers=""
                 lookAndFeel="juce::LookAndFeel_V2" snapPixels="8" snapActive="1"
