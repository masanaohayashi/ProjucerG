...
namespace BinaryData
{
    ...
    const int            jucer_AudioComponentTemplate_cppSize = 4505;

    extern const char*   jucer_AudioComponentTemplate_h;
    const int            jucer_AudioComponentTemplate_hSize = 1509;
    ...
    const int            jucer_AudioPluginARAEditorTemplate_cppSize = 3379;

    extern const char*   jucer_AudioPluginARAEditorTemplate_h;
    const int            jucer_AudioPluginARAEditorTemplate_hSize = 1471;
    ...
    const int            jucer_AudioPluginEditorTemplate_cppSize = 3043;

    extern const char*   jucer_AudioPluginEditorTemplate_h;
    const int            jucer_AudioPluginEditorTemplate_hSize = 1302;
    ...
    const int            jucer_ContentCompTemplate_cppSize = 2586;

    extern const char*   jucer_ContentCompTemplate_h;
    const int            jucer_ContentCompTemplate_hSize = 1207;
